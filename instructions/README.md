...
- [Homework C - [Homework C Practice Instructions](#homework-c-practice-instructions)
  ...
  - [🤖 Use of LLMs](#-use-of-llms)
    ...
    - [Method 1: Code Completion (e.g., GitHub Copilot)](#method-1-code-completion-eg-github-copilot)
    - [Method 2: Prompt-Based Systems (e.g., Claude, ChatGPT)](#method-2-prompt-based-systems-eg-claude-chatgpt)
      - [Generating Individual Test Cases](#generating-individual-test-cases)
      - [Discovering Edge Cases](#discovering-edge-cases)
  ...
  - [📚 Resources](#-resources)
Practice Instructions](#homework-c-practice-instructions)
  - [Learning Objectives](#learning-objectives)
  - [Provided Files](#provided-files)
  - [Write your Code and Tests](#write-your-code-and-tests)
    - [Compiling Your Code](#compiling-your-code)
