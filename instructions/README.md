...
- [Homework C Practice Instructions](#homework-c-practice-instructions)
  ...
  - [Write your Code and Tests](#write-your-code-and-tests)
    - [What to Include in Your Submission](#what-to-include-in-your-submission)
  - [Compiling Your Code](#compiling-your-code)
      - [:star: Compile Frequently :star:](#star-compile-frequently-star)
  - [Report.md](#reportmd)
  - [🤖 Use of LLMs](#-use-of-llms)
    - [Why Use LLMs for Testing?](#why-use-llms-for-testing)
    - [Best Practices for AI-Assisted Testing](#best-practices-for-ai-assisted-testing)
    - [Red Flags - When AI Usage Goes Wrong](#red-flags---when-ai-usage-goes-wrong)
    - [1. Discovering Edge Cases with AI](#1-discovering-edge-cases-with-ai)
    - [2. Generate Tests](#2-generate-tests)
      - [2A. Code Completion (e.g., GitHub Copilot)](#2a-code-completion-eg-github-copilot)
      - [2B. Prompt-Based Systems (e.g., Claude, ChatGPT)](#2b-prompt-based-systems-eg-claude-chatgpt)
        - [Generating Individual Test Cases](#generating-individual-test-cases)
        - [Generating Complete Test Suites](#generating-complete-test-suites)
        - [Additional Prompts for Better Results](#additional-prompts-for-better-results)
...
### 1. Discovering Edge Cases with AI
...
#### 2A. Code Completion (e.g., GitHub Copilot)
...
#### 2B. Prompt-Based Systems (e.g., Claude, ChatGPT)
...
5. Return 1 if the test passes or 0 if it fails.
6. Make sure to print the item being tested as the start of the test.
